...
__version__ = (0, 0, 6)
__all__ = [
    "SupportsLT", "AddableContainer", "grouped_mapping", 
    "grouped_mapping_async", "uniq", "uniq_async", "dups", 
    "dups_async", "iter_dup_keys", "iter_dup_keys_async", 
    "iter_keyed_dups", "iter_keyed_dups_async", 
    "iter_dups", "iter_dups_async", 
]

from collections.abc import (
    AsyncIterable, AsyncIterator, Container, Coroutine, Iterable, Iterator, 
    MutableMapping, 
)
...
@runtime_checkable
class AddableContainer[V](Container[V], Protocol):
    def add(self, v: V, /):
        ...
...
@overload
def iter_dup_keys[K, V](
    it: Iterable[V], 
    /, 
    key: Callable[[V], K], 
    *, 
    get_container: Callable[[], AddableContainer[K]] = set, 
) -> Iterator[K]:
    ...
@overload
def iter_dup_keys[K, V](
...
def iter_dup_keys[K, V](
    ...
    *, 
    get_container: Callable[[], AddableContainer[K]] = set, 
) -> Iterator[K] | AsyncIterator[K]:
    if isinstance(it, AsyncIterable):
        return iter_dup_keys_async(it, key=key, get_container=get_container)
    def call():
...
async def iter_dup_keys_async[K, V](
