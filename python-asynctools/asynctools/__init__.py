...
__version__ = (0, 1, 4)
__all__ = [
    "AsyncExecutor", "awaitable", "is_coroutine", "in_async", "get_loop", "stop_loop", 
    "shutdown_loop", "run_loop", "submit", "get_all_tasks", "cancel_all_tasks", 
    "run_async", "run_in_loop", "as_thread", "ensure_async", "ensure_await", 
    "ensure_coroutine", "ensure_aiter", "async_map", "async_filter", 
    "async_filterfalse", "async_reduce", "async_zip", "async_chain", "async_all", 
    "async_any", "async_compress", "async_cycle", "async_accumulate", "async_enumerate", 
    "async_islice", "async_takewhile", "async_dropwhile", "async_batched", 
    "async_groupby", "async_pairwise", "async_starmap", "async_count", "async_repeat", 
    "async_zip_longest", "async_tee", "call_as_aiter", "to_list", "collect", 
]
...
awaitable = Awaitable.__instancecheck__
is_coroutine = Coroutine.__instancecheck__
...
def ensure_async[**Args, T](
    ...
    ...
def ensure_async[**Args, T](
    func: Callable[Args, T] | Callable[Args, Awaitable[T]], 
    /, 
    threaded: bool = False, 
    ...
    if iscoroutinefunction(func):
        return func
    if threaded:
        return lambda *a, **k: to_thread(func, *a, **k)
    return lambda *a, **k: ensure_coroutine(func(*a, **k))
...
class async_chain[T](AsyncIterator):
    ...
    def __init__(
        ...
        *iterables: Iterable[T] | AsyncIterable[T], 
        ...
        self._anext = type(self).from_iterable(iterables, threaded=threaded).__anext__
